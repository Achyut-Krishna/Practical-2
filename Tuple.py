...
TupleExample = ('Achyut Krishna', 12, [12, 373, '20ce120', 1222.121], 93863.363, {'20ce120': 'Achyut Krishna'},{365, 8746, 365, 24154},{'Achyut', 'Github', 'Microsoft'})
...
print(TupleExample_One[0])  
# accessing first element
# you can access any element of tuple using indexing method
# tuple supports indexing method same as list
print(TupleExample_One[8])  
# accessing last element
print(TupleExample_One) 
# to print whole tuple do not give any index number just write name of tuple variable inside "print"
...
TupleExample_One = TupleExample_One + (112.8938,)  
# Here we are adding element that is 112.8938 into tuple but remember that always write "comma(,)" after element you want to add
print(TupleExample_One)  
# printing whole tuple after updating
...
TupleExample_One_List = list(TupleExample_One)  
# converting tuple to list
TupleExample_One_List.append('Achyut Krishna')  
# appending element "Achyut Krishna" to list
TupleExample_One = tuple(TupleExample_One_List)  
# converting list to tuple
print(TupleExample_One)  
# printing again whole tuple

"""Section 4. convert tuple to string"""
# 4(i). Using join() method
# defining TupleExample_Two
TupleExample_Two = ('Achyut Krishna', ' is', ' studying', ' in', ' Chandubhai S Patel', ' Institute Of Technology', ' in',' Charusat University.')
...
for iterationVariable in TupleExample_Two:  
# running for loop using iterationVariable iterator
StringVariable = StringVariable + iterationVariable  
# storing all element into string variable
print(StringVariable)  
# print string stored into "StringVariable"
